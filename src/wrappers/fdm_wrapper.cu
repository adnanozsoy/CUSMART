...
#include "fdm_wrapper.h"
#include "algos/fdm.cuh"
...
search_info forward_dawg_wrapper(search_parameters params){
	...
	forward_dawg<<<grid_dim, block_dim>>>(
		d_text, params.text_size, d_pattern, params.pattern_size, 
		d_ttrans, d_tlength, d_tsuffix, params.stride_length, d_match);
