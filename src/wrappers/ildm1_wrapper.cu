...
#include "ildm1_wrapper.h"
#include "algos/ildm1.cuh"
#include "wrapper_helpers.h"
#include "util/cutil.cuh"
#include "util/tictoc.h"

search_info improved_linear_dawg1_wrapper(search_parameters params)
{
    ...
    improved_linear_dawg1<<<grid_dim, block_dim>>>(
